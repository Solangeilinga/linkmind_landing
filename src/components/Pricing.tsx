...
export default function Pricing() {
  ...
  return (
    <section id="pricing" style={{ background: "#faf8f5", padding: "7rem 1.5rem" }}>
      <div style={{ maxWidth: 1160, margin: "0 auto" }}>
        <div ref={ref} className="reveal" style={{ textAlign: "center", ...(visible ? { opacity: 1, transform: "none" } : {}) }}>
          ...
          <h2 style={{ fontFamily: "'Lora',serif", fontWeight: 700, fontSize: "clamp(1.8rem,3.5vw,2.8rem)", color: "#1a1625", marginTop: "0.75rem", marginBottom: "0.75rem", letterSpacing: "-.03em" }}>
            Simple et transparent
          </h2>
          <p style={{ fontSize: "1rem", color: "#4a4460", fontWeight: 300, maxWidth: 420, margin: "0 auto" }}>
            Commence gratuitement. Passe Premium si tu veux aller plus loin — jamais de pression.
          </p>
        </div>

        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem", maxWidth: 720, margin: "3.5rem auto 0" }}
          className="grid-cols-1 md:grid-cols-2">
          {/* Free */}
          <div className="reveal" style={{ background: "#f5f3f0", borderRadius: "2rem", padding: "2.5rem 2rem", ...(visible ? { opacity: 1, transform: "none" } : {}) }}>
            ...
            <div style={{ fontFamily: "'Lora',serif", fontWeight: 700, fontSize: "3rem", letterSpacing: "-.04em", color: "#1a1625", lineHeight: 1 }}>0€</div>
          ...
          {/* Premium */}
          <div className="reveal" style={{ background: "#1a1625", borderRadius: "2rem", padding: "2.5rem 2rem", position: "relative", transform: visible ? "scale(1.03) translateY(0)" : "scale(1.03) translateY(20px)", opacity: visible ? 1 : 0, transition: "opacity .7s ease 200ms, transform .7s ease 200ms" }}>
            ...
            <div style={{ fontFamily: "'Lora',serif", fontWeight: 700, fontSize: "3rem", letterSpacing: "-.04em", color: "#faf8f5", lineHeight: 1 }}>4€</div>
