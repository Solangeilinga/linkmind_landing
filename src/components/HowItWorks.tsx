...
export default function HowItWorks() {
  ...
  return (
    <section id="how" style={{ background:"#F5EFED", padding:"7rem 1.5rem" }}>
      <div style={{ maxWidth:1160, margin:"0 auto", display:"grid", gridTemplateColumns:"1fr 1fr", gap:"5rem", alignItems:"center" }}
        ...
        <div>
          <div ref={ref} className="reveal" style={visible ? { opacity:1, transform:"none" } : {}}>
            ...
            <p style={{ fontSize:"1rem", color:"#8A7070", fontWeight:500, lineHeight:1.75, maxWidth:460 }}>
          ...
          <div style={{ marginTop:"2.5rem" }}>
            {steps.map((s, i) => (
              <button key={i} onClick={() => setActive(i)}
                style={{ display:"flex", gap:"1.5rem", padding:"1.4rem 0", width:"100%", textAlign:"left", background:"none", border:"none", borderBottom:i<steps.length-1?"1px solid rgba(28,16,16,.07)":"none", cursor:"pointer", opacity:active===i?1:0.4, transition:"opacity .25s" }}>
                ...
                <div>
                  <div style={{ fontWeight:800, fontSize:"1rem", color:"#1C1010", marginBottom:"0.3rem" }}>{s.title}</div>
        ...
        {/* Screen */}
        <div style={{ background:"#1C1010", borderRadius:"2rem", height:420, position:"relative", overflow:"hidden" }}
