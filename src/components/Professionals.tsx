...
export default function Professionals() {
  ...
  return (
    <section id="professionals" style={{ background: "#FAF7F5", padding: "7rem 1.5rem" }}>
      <div style={{ maxWidth: 1160, margin: "0 auto" }}>
        ...
        <div ref={ref} className="reveal" style={{ textAlign: "center", ...(visible ? { opacity: 1, transform: "none" } : {}) }}>
          ...
          <p style={{ fontSize: "1rem", color: "#8A7070", fontWeight: 500, maxWidth: 520, margin: "0 auto 3.5rem", lineHeight: 1.7 }}>
        ...
        {/* Steps */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5" style={{ marginBottom: "4rem" }}>
          {steps.map((s, i) => {
            ...
            return (
              <div key={i} ref={r}
                ...
                <div style={{ fontWeight: 800, fontSize: "1rem", color: "#1C1010", marginBottom: "0.4rem" }}>{s.title}</div>
            ...
            return (
              <div key={i} ref={r}
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: "1rem" }}>
                  ...
                  <span style={{ fontSize: 11, color: "#8A7070" }}>({pro.count} consultations)</span>
                </div>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  ...
                  <a href="https://drive.google.com/file/d/1oNnJfykm5tPfgp-o9fuA0v7tfkZHuP3E/view?usp=sharing" className="no-underline font-bold transition-all duration-200"
        ...
        <div style={{ display: "flex", justifyContent: "center", flexWrap: "wrap", gap: "2.5rem" }}>
          {[
            ...
            <div key={b.label} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: "0.85rem", fontWeight: 600, color: "#8A7070" }}>
